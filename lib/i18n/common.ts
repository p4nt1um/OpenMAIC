export const commonZhCN = {
  ...
  learningAnalytics: {
    ...
    days: '天',
    progress: '学习进度',
    learningActivity: '学习活动（最近30天）',
    topicPerformance: '主题表现',
    noActivityData: '暂无活动数据。开始学习以查看你的进度！',
    noQuizData: '暂无测验数据。完成一些测验以查看你的主题表现！',
  },
} as const;
...
export const commonEnUS = {
  ...
  learningAnalytics: {
    ...
    days: 'days',
    progress: 'Progress',
    learningActivity: 'Learning Activity (Last 30 Days)',
    topicPerformance: 'Topic Performance',
    noActivityData: 'No activity data yet. Start learning to see your progress!',
    noQuizData: 'No quiz data yet. Complete some quizzes to see your topic performance!',
  },
} as const;
